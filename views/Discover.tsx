...
import { Search, Filter, MapPin, Users, TrendingUp, ChevronRight, CheckCircle, Star, Copy, ExternalLink, X } from 'lucide-react';
...
const Discover: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const savedQuery = sessionStorage.getItem('civicvault_search_query');
    if (savedQuery) {
      setSearchTerm(savedQuery);
      sessionStorage.removeItem('civicvault_search_query');
    }
  }, []);
