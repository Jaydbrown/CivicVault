 ...
 * @notice Factory contract for deploying CivicVault instances as EIP-1167 minimal proxies
...
contract CivicVaultFactory is Ownable {
    ...
    /// @param _implementation Address of CivicVault implementation (deploy separately first)
    ...
    function createDAO(
        ...
        CivicVault(daoAddress).initialize(
            msg.sender,
            name,
            description,
            location,
